    ...
    return (
        ...
        >
            ...
            <div id='header'  className="w-766 text-light text-center">
                ...
                <h1 style={{ marginBottom: '0', fontSize: '60px', fontWeight: '700' }}>Destinasi Sejarah Kami."</h1>
            </div>
            </div>
        </div>
        <div
        ...
        >
            ...
            <div style={{ lineHeight: '10px' }} className="mt-4 mb-5">
                <p className="text-dark">Buton Tengah, di Provinsi Sulawesi Tenggara, Indonesia, menawarkan sejumlah tempat wisata sejarah yang menarik.</p>
                <p className="text-dark">Berikut adalah beberapa destinasi sejarah di Buton Tengah</p>
            </div>
            <CarouselWS />
            </div>
            <div
