        ...
        >
          <SwiperSlide>
            <div className="swiper-slide-content">
              <p>"Saya baru saja kembali dari liburan luar biasa di Buton Tengah. Pulau ini benar-benar surganya wisatawan! Pantai-pantai yang indah, budaya yang kaya, dan makanan lezat membuat pengalaman ini tak terlupakan. Peran pemandu di sini sangat membantu saya dalam mengeksplor spot-spot terindah yang ada di Buton Tengah. Saya pasti akan kembali lagi suatu hari."</p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="swiper-slide-content">
